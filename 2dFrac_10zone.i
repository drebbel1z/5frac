...
frac_aperature1 = 1.5e-4
frac_aperature2 = 1.5e-4
frac_aperature3 = 1.5e-4
frac_aperature4 = 1.5e-4
frac_aperature5 = 1.5e-4
...
inj_poro = .9
matrix_perm = 1.0e-16
matrix_poro = 2.5186127923e-03 #2.0e-4

biot_coeff = 0.47


endTime = 483401 # tracer_start plus 150000
initial_dt = 100
dt_max = 10000
...
[Mesh]
  ...
  [fmg]
    ...
    file = '5frac_Fractures_Local_${mesh_size}m_marked.e'
  []
...
[Postprocessors]
  ...
  []
  [param_frac_aperature1]
    type = Receiver
    default = '${frac_aperature1}'
  []
  [param_frac_aperature2]
    type = Receiver
    default = '${frac_aperature2}'
  []
  [param_frac_aperature3]
    type = Receiver
    default = '${frac_aperature3}'
  []
  [param_frac_aperature4]
    type = Receiver
    default = '${frac_aperature4}'
  []
  [param_frac_aperature5]
    type = Receiver
    default = '${frac_aperature5}'
  []
